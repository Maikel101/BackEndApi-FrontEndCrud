    ...
    public class EmpleadoService : IEmpleadoService
    {
        ...
        public async Task<List<Empleado>> GetList()
        {
            try
            {
                ...
                lista = await _dbContext.Empleados.Include(dpt =>
                dpt.IdDepartamentoNavigation).ToListAsync();
        ...
        public async Task<Empleado> Get(int idEmpleado)
        {
            try
            {
                ...
                encontrado = await _dbContext.Empleados.Include(dpt =>
                dpt.IdDepartamentoNavigation)
